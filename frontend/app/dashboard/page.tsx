    ...
    <AppLayout>
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-800">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2.5 bg-slate-900 hover:bg-slate-800 text-slate-300 border border-slate-800 rounded-xl text-xs font-semibold disabled:opacity-50 transition-all"
            >
              Clear All
            </button>
            <button
        ...
        >
          ...
          <div className="w-16 h-16 bg-indigo-600/20 border border-indigo-500/30 rounded-2xl flex items-center justify-center mx-auto text-indigo-400 mb-4 shadow-lg shadow-indigo-600/10">
            <FileUp className="w-8 h-8" />
          </div>

          <h3 className="text-xl font-bold text-white mb-1">
            Drop your documents here, or <span className="text-indigo-400 underline decoration-indigo-500/50">browse</span>
          </h3>
              ...
              {documents.map((doc, idx) => (
                ...
                >
                  <div className="flex items-center gap-3 overflow-hidden">
                    <div className="p-2.5 bg-slate-800 rounded-xl text-slate-300 shrink-0">
